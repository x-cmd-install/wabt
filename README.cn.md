...
![wabt](https://repo.x-cmd.io/wabt.svg?lang=zh)
...
合计: **97,308** 行代码（覆盖前 5 种语言、共 **211** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Cpp | 47,601 | 2,654 | 6,432 | 81 |
| WebAssembly | 28,213 | 305 | 1,854 | 36 |
| CHeader | 8,980 | 2,025 | 1,941 | 63 |
| C | 3,705 | 399 | 574 | 17 |
| Python | 3,153 | 338 | 650 | 14 |
...
- **Star**: 8,124 · **Fork**: 823 · **开放 issue**: 857 · **贡献者**: 183

## 累计统计

- **发布数**: 41 · **已合并 PR**: 1720 · **开放 PR**: 59 · **已关闭 issue**: 676 · **开放 issue**: 181 · **提交数**: 2620

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-11 | 0 | 11 | 14 | 2 | 6 | 13 |
| last60d | 2026-07-12 | 0 | 30 | 15 | 2 | 6 | 31 |
| 90d | 2026-06-12 | 0 | 65 | 16 | 3 | 6 | 67 |
| last180d | 2026-03-14 | 1 | 85 | 18 | 5 | 18 | 88 |
| 360d | 2025-09-15 | 4 | 120 | 23 | 18 | 35 | 127 |
| last720d | 2024-09-20 | 5 | 195 | 39 | 47 | 64 | 200 |
...
在 [repology.org](https://repology.org/project/wabt) 上共有 **90** 个发行版报告此项目。**34** 个 ✅ 已是最新上游版本，**53** 个 ⚠️ 使用旧版本。
...
wabt 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `wabt` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/wabt.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260910.yml` · 2026-09-10T22:57:53Z._
